...
class WorkoutWeekDay{
  ...
  int get notRestDrillBlocksCount => isSet ? drillBlocks.where((b) => !(b is WorkoutRestDrillBlock)):0;
...
class WorkoutSingleDrillBlock extends WorkoutDrillsBlock{
  WorkoutSingleDrillBlock(WorkoutDrill drill) : super(type: WorkoutDrillType.SINGLE, drills: [drill]);
...
class WorkoutMultisetDrillBlock extends WorkoutDrillsBlock{
  WorkoutMultisetDrillBlock(List<WorkoutDrill> drill) : super(type: WorkoutDrillType.MULTISET, drills: drill);
...
class WorkoutAmrapDrillBlock extends WorkoutDrillsBlock{
  int minutes;
  WorkoutAmrapDrillBlock({this.minutes, List<WorkoutDrill> drills}) : super(type: WorkoutDrillType.AMRAP, drills: drills);
...
class WorkoutForTimeDrillBlock extends WorkoutDrillsBlock{
  ...
  WorkoutForTimeDrillBlock({this.timeCapMin, this.rounds, this.restBetweenRoundsMin, List<WorkoutDrill> drills}) : super(type: WorkoutDrillType.Fortime, drills: drills);
...
class WorkoutEmomDrillBlock extends WorkoutDrillsBlock{
  ...
  WorkoutEmomDrillBlock({this.timeCapMin, this.intervalMin, List<WorkoutDrill> drills}) : super(type: WorkoutDrillType.EMOM, drills: drills);

  WorkoutEmomDrillBlock copy(){
    return WorkoutEmomDrillBlock(timeCapMin: timeCapMin, intervalMin: intervalMin, drills: drills);
  }
}

class WorkoutRestDrillBlock extends WorkoutDrillsBlock{
  int timeMin;
  WorkoutRestDrillBlock({this.timeMin}) : super(type: WorkoutDrillType.REST, drills: []);
